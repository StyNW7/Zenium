...
export function ZeniumUserPage() {
  ...
  const changePassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage({ 
        type: 'error', 
        text: error.response?.data?.message || 'Failed to change password. Please make sure the current password is correct.' 
      });
    } finally {
      setLoading(false);
    }
        ...
        {activeTab === 'security' && (
          <div className="bg-gray-900/50 rounded-lg border border-yellow-500/20 p-6">
            ...
            <div className="mt-8 pt-6 border-t border-gray-800">
              <h3 className="text-md font-medium text-red-400 mb-2">Log Out</h3>
